...
// //при скроле вниз после обновления возврат в начало страницы
// function onScroll() {
...
//   '.menu__link[data-goto], .button-primary[data-goto], #home, #ourteamsection, #howtobecomesection, #contactssection'
// );
...
// const ourteamLink = document.querySelector('#ourteamsection');
// const howtobecomeLink = document.querySelector('#howtobecomesection');
// const contactsLink = document.querySelector('#contactssection');
...
//     e.preventDefault();
//     setTimeout(function () {
//       window.location.href = './index.html#ourteamsection';
//     }, 150);
//     document.body.classList.remove('_scroll-lock');
//     menuIcon.classList.remove('_active');
//     menuBody.classList.remove('_active');
...
//     e.preventDefault();
//     setTimeout(function () {
//       window.location.href = './index.html#howtobecomesection';
//     }, 250);
//     document.body.classList.remove('_scroll-lock');
//     menuIcon.classList.remove('_active');
//     menuBody.classList.remove('_active');
...
//     e.preventDefault();
//     setTimeout(function () {
//       window.location.href = './index.html#contactssection';
//     }, 150);
//     document.body.classList.remove('_scroll-lock');
//     menuIcon.classList.remove('_active');
//     menuBody.classList.remove('_active');
